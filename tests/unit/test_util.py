...
class TestPretrainedModelLoading:
    ...
    def test_get_pretrained_model_download_and_extract(
        self, mock_makedirs, mock_exists, mock_urlretrieve, 
        mock_gzip, mock_copyfileobj, mock_load
    ):
...
class TestDataFormatting:
    ...
    def test_formatData_none_values(self):
        ...
        with pytest.raises(UtilError, match="answer, response, and information must be provided"):
